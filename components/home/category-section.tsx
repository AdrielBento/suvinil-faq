      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {categories.map((category) => (
          <Button
            ...
            className="flex h-auto flex-col items-start gap-2 rounded-2xl border border-border/70 bg-card px-4 py-5 text-left shadow-sm transition hover:border-primary/60 hover:shadow-md"
          >
